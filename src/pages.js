...
export function loginPage(signinUrl) {
...
export function loginCompletePage(userEmail) {
...
export function syncPage(userEmail, changes) {
    var html = '<div class="ms-Grid">';
    html += buttonRow.replace('%email%', userEmail);
...
export function itemDetailPage(userEmail, event) {
    var html = '<div class="ms-Grid">';
    html += buttonRow.replace('%email%', userEmail);
    ...
    html += '  </div>';
    html += '  <div class="ms-Grid-col ms-u-sm6">';
    html += '    <a class="ms-Button ms-Button--primary" href="/deleteitem?' + stringify({ id: event.Id }) + '"><span class="ms-Button-label">Delete item</span></a>';
    html += '  </div>';
    html += '</div>';
    html += '</form>';
